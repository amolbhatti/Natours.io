...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1vbHNpbm5naCIsImEiOiJja3FqM3ppZzEwY3MyMm9xc2sxajM2eWc4In0.Wb5HaViVvOHMzXU2le0Pfg';
  ...
  locations.forEach(function (element) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(element.coordinates).addTo(map); // app popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(element.coordinates).setHTML("<p>Day ".concat(element.day, ": ").concat(element.description, "</p>")).addTo(map); // extends map bounds to include current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://localhost:3000/api/v1/user/logout');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/user/updateMyPassword' : 'http://localhost:3000/api/v1/user/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51HKAC6GcejTQJKnXSSwSGdhDgD7sQcADBZgEU18AdCfRKGex2WYofBnr50ifGj02yUHq3HocOgHzw0Byem6Q4TMx00VGGyYqNc');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/booking/checkout-sessin/".concat(tourId));
...
var formUserPasswords = document.querySelector('.form-user-password');
...
if (formUserPasswords) {
  formUserPasswords.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
